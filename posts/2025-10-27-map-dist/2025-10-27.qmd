...
fl_parks <- st_read("Florida_State_Parks_Boundaries/Florida_State_Parks_Boundaries.shp")
state <- st_read("Detailed_Florida_State_Boundary/Detailed_Florida_State_Boundary.shp")
```
