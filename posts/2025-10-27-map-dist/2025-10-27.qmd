...
species_occ <- read.csv("posts/2025-10-27-map-dist/Florida-Ficus-Occurrence-Collections-Update-June-2025.csv")
fl_parks <- st_read("posts/2025-10-27-map-dist/data/Florida_State_Parks_Boundaries/Florida_State_Parks_Boundaries.shp")
state <- st_read("posts/2025-10-27-map-dist/data/Detailed_Florida_State_Boundary/Detailed_Florida_State_Boundary.shp")
```
