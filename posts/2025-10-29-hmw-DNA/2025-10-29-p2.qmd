...
I am sharing the DNA extraction protocol we use in out lab. It is a **modified Qiagen Genomic-tip protocol** developed to maximize DNA yield and integrity while minimizing degradation.

## DNA Extraction from *Ficus* Leaves

The extraction of HMW DNA from *Ficus aurea* and *Ficus citrifolia* was adjusted to overcome the challenges posed by secondary metabolites, polysaccharides, and thick cuticles typical of *Ficus* species.
...
Extracting DNA from fig wasps posed different challenges due to their small size, chitinous exoskeletons, and low DNA yield. This required maximizing lysis efficiency while minimizing DNA fragmentation. We heavily reference this [user-developed Qiagen protocol](https://www.qiagen.com/us/resources/resourcedetail?id=cb2ac658-8d66-43f0-968e-7bb0ea2c402a&lang=en).
